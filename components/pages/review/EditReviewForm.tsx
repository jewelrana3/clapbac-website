...
export default function EditReviewForm({ review }: any) {
  const router = useRouter();
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [isAIAutoFillLoading, setIsAIAutoFillLoading] = useState(false);
  const [rating, setRating] = useState<Rating>({
    yourRating: review?.reviewRating || 0,
    bussinessRating: review?.clapbacRating || 0,
    ratingError: "",
    businessRatingError: "",
  });
  ...
  const {
    ...
    defaultValues: {
      ...
      experienceDate: review?.experienceDate?.split("T")[0] || "",
      clapbacTitle: review?.clapbacTitle || "",
      clapbacMessage: review?.clapbacMessage || "",
      reviewerType: review?.reviewerType || "",
      reviewerConsequence: review?.reviewerConsequence || "",
    },
  });
  ...
  const onSubmit = async (data: any) => {
    ...
    toast.loading("Updating...", { id: "review" });
    setIsSubmitting(true);
    try {
      const res = await myFetch(`/reviews/${review?._id}`, {
        method: "PATCH",
        body: {
          ...data,
      ...
      if (res?.success) {
        toast.success("Review updated successfully!", { id: "review" });
        reset();
        revalidate("reviews");
        setRating({
          yourRating: 0,
      ...
      >
        ...
        <div>
          ...
          {errors.reviewerName && (
            <p className="text-red-500 text-sm">
              {typeof errors.reviewerName.message === "string"
        ...
        <div>
          ...
          {errors.reviewerAddress && (
            <p className="text-red-500 text-sm">
              {typeof errors.reviewerAddress.message === "string"
        ...
        <div>
          ...
          {errors.reviewMessage && (
            <p className="text-red-500 text-sm">
              {typeof errors.reviewMessage.message === "string"
        ...
        <div>
          ...
          {errors.experienceDate && (
            <p className="text-red-500 text-sm">
              {typeof errors.experienceDate.message === "string"
        ...
        <div>
          ...
          {errors.reviewSource && (
            <p className="text-red-500 text-sm">
              {typeof errors.reviewSource.message === "string"
        ...
        <div>
          ...
          {errors.sourceLink && (
            <p className="text-red-500 text-sm">
              {typeof errors.sourceLink.message === "string"
        ...
        <div>
          ...
          {errors.clapbacTitle && (
            <p className="text-red-500 text-sm">
              {typeof errors.clapbacTitle.message === "string"
        ...
        <div>
          ...
          {errors.clapbacMessage && (
            <p className="text-red-500 text-sm">
              {typeof errors.clapbacMessage?.message === "string"
          ...
          <Controller
            ...
            render={({ field }) => (
              <>
                ...
                {errors.reviewerType && (
                  <p className="text-red-500 text-sm">
                    {typeof errors.reviewerType.message === "string"
            ...
            render={({ field }) => (
              <>
                ...
                {errors.reviewerConsequence && (
                  <p className="text-red-500 text-sm">
                    {typeof errors.reviewerConsequence.message === "string"
